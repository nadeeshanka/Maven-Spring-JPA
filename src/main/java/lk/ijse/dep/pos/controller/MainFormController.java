...
public class MainFormController implements Initializable {
    ...
    private String getIp(){return env.getRequiredProperty("ijse.dep.ip");}
    private String getPort(){return env.getRequiredProperty("ijse.dep.port");}
    private String getDatabase(){return env.getRequiredProperty("ijse.dep.db");}
            ...
            Task<Void> task = new Task<Void>() {
                ...
                protected Void call() throws Exception {
                    ...
                    if (getPassword().length() > 0){
                        ...
                        commands = new String[]{"mysqldump", "-h", getIp(), "-u", getUsername(), "--port",getIp(),
